...
interface OfficeCreationAttributes extends Optional<OfficeAttributes, 'office_id' | 'created_at' | 'updated_at'> {
}

// Create the model class
export class Office extends Model<OfficeAttributes, OfficeCreationAttributes> implements OfficeAttributes {
